...
class BookModal extends Component {
  ...
  findFormErrors = () => {
    ...
    if (!reviewTitle || reviewTitle === "")
      errors.reviewTitle = "Review title cannot be blank!";
    if (!reviewComments || reviewComments === "")
      errors.reviewComments = "Review cannot be blank!";
      ...
      <>
        ...
        <Modal show={addReview} onHide={closeModal} style={{ width: "90vw" }}>
          ...
          <Modal.Body>
              ...
              <Col>
                <Form.Group className="mb-3">
                  <Form.Control
                    ...
                    isInvalid={!!errors.reviewComments}
                  />
                  <Form.Control.Feedback type="invalid">
            ...
            <Row>
              <Col>
                <b>How should I prepare for an interview at this company?</b>
              </Col>
            </Row>
            <Row>
              <Col>
